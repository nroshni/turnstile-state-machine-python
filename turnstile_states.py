...
if __name__ == "__main__":
    bs = LockedState()
    print('1: ', bs.fixed_event())
    print('2: ', bs.pass_event())
    print('3: ', bs.failed_event())
    # print('4: ', bs.coin_event(10))
    print('4: ', bs.coin_event(0.5))
    print('4: ', bs.coin_event(0.5))
    print('1: ', bs.thank_you_msg())
    print('2: ', bs.alarm_msg())
    print('3: ', bs.in_order_msg())
    print('4: ', bs.out_of_order_msg())
